...
SET SUMMARY="Elders.Proteus"
SET DESCRIPTION="Elders.Proteus"

%FAKE% %NYX% "target=%TARGET%" appName=Elders.Proteus appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Proteus nugetkey=d64cf0db-051e-4e2a-a0fd-fc182108ed25